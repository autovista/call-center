    <script>
				...
				function test()
			{
				...
				$.ajax(
				   {
						url:"<?php echo site_url('website_leads/team_leader_filter'); ?>
					",
					type:'POST',
					data:{status:s,fromdate:f,todate:t,enq:e,assign_to:a},
                              ...
                              <div class="col-lg-3 col-md-3 col-sm-3 col-xs-12" style="padding:20px;">
                                      ...
                                      <div class="col-lg-3 col-md-3 col-sm-3 col-xs-12" style="padding:20px;">
                                       ...
                                       <div class="form-group">
                                              ...
                                              <select class="filter_s col-md-12 col-xs-12 form-control" id="assign_to" name="assign_to" required>
												 <option value="">Select Telecaller Name</option>
											<?php foreach ($select_telecaller as $fetch) {
											?>	
