				...
				<div class="panel-body">
					...
					<form name="myform" action="<?php echo $var1; ?>" method="post" >
                     ...
                     <?php				
								...
								$web_query = $this->db->query("select lead_source,enquiry_for,count(lead_source) as wcount from lead_master where lead_source!='Facebook' and assign_to_telecaller='$assign_to' group by lead_source ") ->result();
											$i=0;
