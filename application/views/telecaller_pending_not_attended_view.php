<!--<ol class="breadcrumb bc-3" >
	...
	<li class="active">
		<strong>Pending Leads - Not Attended</strong>
	</li>
</ol>
-->
	...
	<div class="main_container">
		...
		<div class="right_col" role="main">
			...
			<div id="abc">
				...
				<h1 style="text-align:center;">Pending Leads - Not Attended</h1>
				<div class="table-responsive"  style="overflow-x:auto;">
					...
					<td><a href="<?php echo site_url();?>add_followup/detail/<?php echo $fetch->enq_id?>/pending">Add Follow Up </a> 
						 | <a href="<?php echo site_url();?>remove_duplicate/leads/<?php echo $enq_id;?>/pending"  onclick="return confirm('Do you want to delete this record?')">Remove</a></td>
