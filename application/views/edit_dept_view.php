			...
			<div class="panel panel-primary">
				...
				<div class="panel-body">
					...
					<form action="<?php echo $var1;?>" method="post">
						...
						foreach($select_dept as $fetch) 
						{
							
									
					?>
					
						<input type='hidden' name='id' value='<?php echo $fetch ->dept_id;?>'>	
									<label class="control-label col-md-4 col-sm-4 col-xs-12" for="first-name">Department Name: </label>
									<div class="col-md-5 col-sm-5 col-xs-12">
					
									<input type="text" required onkeypress="return alpha(event)" autocomplete="off" class="form-control" id="name" value="<?php echo $fetch->dept_name;?>"name="dept_name">
