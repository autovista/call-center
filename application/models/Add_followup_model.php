...
//Select All Lead Data
	...
	function insert_followup() {
		...
		(`leadid`, `activity`, `comment`, `nextfollowupdate`,  `assign_to`, `disposition`,`eagerness`, `transfer_reason`, `date`,`visit_status` ,`visit_location`,`visit_booked`,`visit_booked_date`,`sale_status`,`car_delivered`,`created_time`) 
		VALUES ('$enq_id','$activity','$comment','$followupdate','$assign_to_telecaller','$disposition','$eagerness','$transfer_reason','$today1','$visit_status','$visit_location','$visit_booked','$visit_date','$sales_status','$car_delivered','$time')") or die(mysql_error());
