...
function select_buyer_type () {
	...
	}else if(document.getElementById('buyer_type').value=='First' )
	{
		...
		document.getElementById('buy_used_div').style.display = "none";
	}else if(document.getElementById('buyer_type').value=='Sold Used Car' )
	{
		document.getElementById('first_div').style.display = "none";
		document.getElementById('exchange_div').style.display = "block";
		document.getElementById('buy_used_div').style.display = "none";
	}else if(document.getElementById('buyer_type').value=='Buy Used Car' )
	{
		document.getElementById('first_div').style.display = "none";
		document.getElementById('exchange_div').style.display = "none";
...
function get_followup_div()
{
	...
	else if(buyer == 'Buy Used Car')
	{
		document.getElementById('first_div').style.display = "none";
		document.getElementById('exchange_div').style.display = "none";
		document.getElementById('buy_used_div').style.display = "block";
	}
	else if(buyer == 'Sold Used Car')
	{
		document.getElementById('first_div').style.display = "none";
		document.getElementById('exchange_div').style.display = "block";
		document.getElementById('buy_used_div').style.display = "none";
